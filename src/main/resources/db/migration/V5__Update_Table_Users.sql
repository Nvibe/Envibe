ALTER TABLE user_account ADD country varchar(100) NOT NULL;
ALTER TABLE user_account ADD birthday DATE NOT NULL;
ALTER TABLE user_account ADD last_name varchar(255) NOT NULL;
ALTER TABLE user_account ADD first_name varchar(255) NOT NULL;
